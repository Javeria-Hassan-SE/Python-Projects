...
class Ui_ForgotPasswordWindow(object):
    def setupUi(self, ForgotPasswordWindow):
        ...
        ForgotPasswordWindow.resize(1024, 644)
        icon = QtGui.QIcon()
        ...
        ForgotPasswordWindow.setStyleSheet("QFrame#login_form{\n"
...
"font: 25 22pt \"Bahnschrift Light\";")
        ...
        self.change_password_btn = QtWidgets.QPushButton(self.login_form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.change_password_btn.sizePolicy().hasHeightForWidth())
        self.change_password_btn.setSizePolicy(sizePolicy)
        self.change_password_btn.setMinimumSize(QtCore.QSize(250, 40))
        self.change_password_btn.setMaximumSize(QtCore.QSize(100, 40))
        self.change_password_btn.setStyleSheet("background-color: rgb(111, 168, 68);\n"
"border-radius: 15px;\n"
...
"horizontal-align: center;")
        ...
        self.logingrid_layout.addWidget(self.change_password_btn, 6, 0, 1, 2, QtCore.Qt.AlignHCenter)
...
"margin:5px;")
        ...
        self.logingrid_layout.addWidget(self.error_label, 7, 0, 1, 2)
...
"")
    ...
    def retranslateUi(self, ForgotPasswordWindow):
        ...
        self.RAAS_heading_label.setText(_translate("ForgotPasswordWindow", "RAAS"))
        self.ET_label.setText(_translate("ForgotPasswordWindow", "INSTITUTE OF EMERGING TECHNOLOGIES"))
        self.change_password_btn.setText(_translate("ForgotPasswordWindow", "Change"))
        self.password_line_edit.setPlaceholderText(_translate("ForgotPasswordWindow", "New Password"))
        self.user_login_heading.setText(_translate("ForgotPasswordWindow", "ADMIN LOGIN"))
        self.test_portal_heading.setText(_translate("ForgotPasswordWindow", "Forgot Password?"))
        self.email_lineEdit.setPlaceholderText(_translate("ForgotPasswordWindow", "Email"))
import icon_rc
