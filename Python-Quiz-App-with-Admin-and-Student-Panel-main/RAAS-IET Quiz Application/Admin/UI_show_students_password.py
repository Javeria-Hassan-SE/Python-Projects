...
# Form implementation generated from reading ui file 'show_students_password.ui'
#
...
class Ui_StudentsPasswordWindow(object):
    def setupUi(self, StudentsPasswordWindow):
        StudentsPasswordWindow.setObjectName("StudentsPasswordWindow")
        StudentsPasswordWindow.resize(1024, 640)
        StudentsPasswordWindow.setStyleSheet("QFrame#login_form{\n"
...
"QTabWidget{background: gray;}")
        self.centralwidget = QtWidgets.QWidget(StudentsPasswordWindow)
...
"font: 18pt \"Bahnschrift Ligh\";")
        ...
        self.show_students_password_tableWidget = QtWidgets.QTableWidget(self.main_body)
        self.show_students_password_tableWidget.setStyleSheet("font: 12pt \"Bahnschrift Ligh\";")
        self.show_students_password_tableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.show_students_password_tableWidget.setObjectName("show_students_password_tableWidget")
        self.show_students_password_tableWidget.setColumnCount(7)
        self.show_students_password_tableWidget.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.show_students_password_tableWidget.setHorizontalHeaderItem(6, item)
        self.show_students_password_tableWidget.horizontalHeader().setDefaultSectionSize(150)
        self.horizontalLayout.addWidget(self.show_students_password_tableWidget)
        ...
        StudentsPasswordWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(StudentsPasswordWindow)
        QtCore.QMetaObject.connectSlotsByName(StudentsPasswordWindow)

    def retranslateUi(self, StudentsPasswordWindow):
        _translate = QtCore.QCoreApplication.translate
        StudentsPasswordWindow.setWindowTitle(_translate("StudentsPasswordWindow", "MainWindow"))
        self.ET_label.setText(_translate("StudentsPasswordWindow", "INSTITUTE OF EMERGING TECHNOLOGIES"))
        self.RAAS_label.setText(_translate("StudentsPasswordWindow", "RAAS"))
        self.center_label.setText(_translate("StudentsPasswordWindow", " STUDENTS"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("StudentsPasswordWindow", "ID"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("StudentsPasswordWindow", "Name"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("StudentsPasswordWindow", "Course ID"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("StudentsPasswordWindow", "Course Batch"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("StudentsPasswordWindow", "Password"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("StudentsPasswordWindow", "Contact"))
        item = self.show_students_password_tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("StudentsPasswordWindow", "Email"))
import icon_rc
...
if __name__ == "__main__":
    ...
    StudentsPasswordWindow = QtWidgets.QMainWindow()
    ui = Ui_StudentsPasswordWindow()
    ui.setupUi(StudentsPasswordWindow)
    StudentsPasswordWindow.show()
    sys.exit(app.exec_())
